...
sorttable = {
    ...
    makeSortable: function(table) {
        ...
        if (sortbottomrows) {
            ...
            for (var i = 0; i < sortbottomrows.length; i += 1) {
                tfo.appendChild(sortbottomrows[i])
            }
            delete sortbottomrows
        }
        headrow = table.tHead.rows[0].cells;
        for (var i = 0; i < headrow.length; i += 1) {
            if (!headrow[i].className.match(/\bsorttable_nosort\b/)) {
                ...
                dean_addEvent(headrow[i], "click", function(e) {
                    if (this.className.search(/\bsorttable_sorted\b/) != -1) {
                        ...
                        sortrevind.innerHTML = stIsIE ? '&nbspA' : '&nbsp;↑';
                    ...
                    if (this.className.search(/\bsorttable_sorted_reverse\b/) != -1) {
                        ...
                        sortfwdind.innerHTML = stIsIE ? '&nbspZ' : '&nbsp;↓';
                    ...
                    for (var j = 0; j < row_array.length; j += 1) {
    ...
    guessType: function(table, column) {
        ...
        for (var i = 0; i < table.tBodies[0].rows.length; i += 1) {
